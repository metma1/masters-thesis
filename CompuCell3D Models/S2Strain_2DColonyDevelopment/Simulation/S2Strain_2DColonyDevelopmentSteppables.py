...
class ConstraintInitializerSteppable(SteppableBasePy):
    ...
    def start(self):
        ...
        # Manually assigned cell type per placement
            ...
            cell_strain_arr = np.array([self.S2_ACTIVE, self.S2_ACTIVE,
                                        self.S1_ACTIVE, self.S1_ACTIVE, self.S1_ACTIVE, self.S1_ACTIVE, self.S1_ACTIVE,
                                        self.S2_ACTIVE,
                                        self.S1_ACTIVE, self.S1_ACTIVE, self.S1_ACTIVE, self.S1_ACTIVE, self.S1_ACTIVE,
                                        self.S2_ACTIVE,
...
class UptakeSteppable(SteppableBasePy):
    ...
    def step(self, mcs):
        ...
        # Oxygen, nutrient uptake for passive/active cell types
